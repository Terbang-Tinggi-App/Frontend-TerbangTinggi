...
export function GoogleLogin({ type }) {
  ...
  return (
    <button
      className="rounded-[4px] btn bg-white text-black border-gray-300 hover:bg-gray-100 hover:border-gray-400 text-center w-full"
      type="button"
      onClick={googleLogin}>
      <svg className="mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="23px">
        <path
          fill="#FFC107"
