...
export function ETicket() {
  ...
  useEffect(() => {
    ...
    (async () => {
      const { data } = await axios.get(`${BASE_API_URL}/transaction/generatepdf/${paymentId}`, {
        headers: {
          Authorization: localStorage.getItem('token')
        }
      });
  ...
  return (
    <Protected>
      ...
      <div className="mx-4 md:mx-32 mt-8">
        ...
        <div className="my-8 p-8 rounded-[4px]  bg-slate-200">
          {/* ticket header start */}
        ...
        <div className="flex gap-4 flex-col flex-wrap my-8">
          <h2 className="text-xl font-semibold">Download your e-tikcet and boarding pass below</h2>
